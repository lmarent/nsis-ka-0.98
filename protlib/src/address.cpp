...
/// ----------------------------------------------------------
/// $Id: address.cpp 5445 2010-06-16 12:35:42Z bless $
/// $HeadURL: https://svn.ipv6.tm.uka.de/nsis/protlib/branches/20091014-autotools/src/address.cpp $
// ===========================================================
//                      
...
hostaddress::is_bogus_source() const
{
  ...
  { // IPv6
	  if ( IN6_ARE_ADDR_EQUAL(ipv6addr.s6_addr,in6addr_any.s6_addr) ||
	       IN6_ARE_ADDR_EQUAL(ipv6addr.s6_addr,in6addr_loopback.s6_addr) )
		  return true;
  }
