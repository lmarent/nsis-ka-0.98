...
/// ----------------------------------------------------------
/// $Id: tp_over_udp.cpp 4210 2009-08-06 11:22:29Z bless $
/// $HeadURL: https://svn.ipv6.tm.uka.de/nsis/protlib/branches/20091014-autotools/src/tp_over_udp.cpp $
// ===========================================================
//                      
 ...
 * @param use_exisiting_connection whether establishing a new connection is allowed (not applicable here)
