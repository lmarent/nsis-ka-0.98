...
/// ----------------------------------------------------------
/// $Id: address.h 5445 2010-06-16 12:35:42Z bless $
/// $HeadURL: https://svn.ipv6.tm.uka.de/nsis/protlib/branches/20091014-autotools/include/address.h $
// ===========================================================
//                      
...
class hostaddress : public address {
  ...
  public:
	...
	/// convert to IPv4 is it is a mapped IPv6 address
