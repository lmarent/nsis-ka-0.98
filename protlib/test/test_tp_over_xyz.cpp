...
class test_tp_over_xyz : public CppUnit::TestCase {
  ...
  void test_send_receive_UDPv4() { test_send_receive<TPoverUDP,TPoverUDPParam>("127.0.0.1"); }
  void test_send_receive_TCPv4() { test_send_receive<TPoverTCP,TPoverTCPParam>("127.0.0.1"); }
#ifdef _USE_SCTP
  void test_send_receive_SCTPv4() { test_send_receive<TPoverSCTP,TPoverSCTPParam>("127.0.0.1"); }
#endif

  void test_send_receive_UDPv6() { test_send_receive<TPoverUDP,TPoverUDPParam>("::1"); }
  void test_send_receive_TCPv6() { test_send_receive<TPoverTCP,TPoverTCPParam>("::1"); }
#ifdef _USE_SCTP
  void test_send_receive_SCTPv6() { test_send_receive<TPoverSCTP,TPoverSCTPParam>("::1"); }
#endif
};
...
test_tp_over_xyz::test_send_receive(const char* destaddrstr) {
	...
	while (num_msgs < num_testmsgs) 
	{
	  try {
	    ...
	    tpthread.get_thread_object()->send(datamsg, destinationaddr, NULL, false);
