...
/// ----------------------------------------------------------
/// $Id: ntlp_statemodule_api.cpp 5998 2011-03-09 09:02:34Z bless $
/// $HeadURL: https://svn.tm.kit.edu/nsis/ntlp/branches/20091014-autotools/src/ntlp_statemodule_api.cpp $
// ===========================================================
//                      
...
//    delete apimsg;
  ...
  transtype= (apimsg->get_data()->get_size() > MAX_NSLP_PAYLOAD) ? tx_cmode : tx_dmode;
