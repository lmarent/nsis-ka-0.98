...
/// ----------------------------------------------------------
/// $Id: signalingmodule_ntlp.h 5716 2010-10-13 20:15:05Z bless $
/// $HeadURL: https://svn.ipv6.tm.uka.de/nsis/ntlp/branches/20091014-autotools/src/signalingmodule_ntlp.h $
// ===========================================================
//                      
...
{
  typedef hash_map<protocol_t,TP*> protocol_map_t;
