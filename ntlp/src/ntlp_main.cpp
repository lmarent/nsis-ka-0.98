...
/// ----------------------------------------------------------
/// $Id: ntlp_main.cpp 5731 2010-10-23 19:59:39Z bless $
/// $HeadURL: https://svn.ipv6.tm.uka.de/nsis/ntlp/branches/20091014-autotools/src/ntlp_main.cpp $
// ===========================================================
//                      
...
main(int argc, char** argv) 
{
  ...
  // init gist configuration parameters
