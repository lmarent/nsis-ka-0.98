...
/// ----------------------------------------------------------
/// $Id: routingtable.h 5857 2011-02-04 15:21:17Z bless $
/// $HeadURL: https://svn.ipv6.tm.uka.de/nsis/ntlp/branches/20091014-autotools/src/routingtable.h $
// ===========================================================
//                      
...
{
 public:
  typedef hash_map<routingkey, routingentry*, hash_routingkey, eqroutingkey> rkey_to_rentry_hashmap_t;
  typedef hash_map<nli, ma_entry, hash_nli, eqnli> ma_hashmap_t;
  typedef hash_map<nli, uint32, hash_nli, eqnli> peer_to_sii_hashmap_t;
  typedef hash_map<uint32, nli> sii_to_peer_hashmap_t;
  typedef hash_map<uint32, uint32> rao_to_nslpid_hashmap_t;
