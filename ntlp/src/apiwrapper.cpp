...
/// ----------------------------------------------------------
/// $Id: apiwrapper.cpp 5716 2010-10-13 20:15:05Z bless $
/// $HeadURL: https://svn.ipv6.tm.uka.de/nsis/ntlp/branches/20091014-autotools/src/apiwrapper.cpp $
// ===========================================================
//                      
...
APIWrapper::process_api_msg(APIMsg* apimsg) 
{
    ...
    hash_map<uint32, udsaddress>::iterator hm_iter;
