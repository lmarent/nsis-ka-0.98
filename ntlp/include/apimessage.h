...
/// ----------------------------------------------------------
/// $Id: apimessage.h 5716 2010-10-13 20:15:05Z bless $
/// $HeadURL: https://svn.ipv6.tm.uka.de/nsis/ntlp/branches/20091014-autotools/include/apimessage.h $
// ===========================================================
//                      
...
///typedef
    typedef hash_map<uint32, message::qaddr_t, hash<uint32>, equal_to<uint32> >  nslptable_t;
